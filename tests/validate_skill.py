...
def validate_repo_docs() -> None:
    ...
    assert_contains(readme, "## How humanize works", "README flowchart")
    assert_contains(readme, "```mermaid", "README flowchart")
    assert_contains(readme, "flowchart TD", "README flowchart")
    assert_contains(readme, "Humanize Check", "README flowchart")
    assert_contains(readme, "Magnifica Humanitas LAW gates", "README flowchart")
    assert_contains(readme, "Proceed with safeguards", "README flowchart")
    assert_contains(readme, "Constrain and reframe", "README flowchart")
    assert_contains(readme, "Refuse and redirect", "README flowchart")
